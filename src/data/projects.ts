export interface Project {
   ...
   *  over `image` and `heroImage` wherever the project's frame is filled. */
  cover?: string
  /** the 16:9 banner at the top of the case study. Falls back to `image`, which is cut
   *  for the 4:3 card and loses its top and bottom in a wide frame. */
  heroImage?: string
  href: string
  externalHref?: string
}
